...
echo "- run_spot"
echo "- run_rapid"
echo "- *.sh files (including this script)"
echo ""
...
echo "Removing files..."
find . -maxdepth 1 -type f ! -name "run_spot" ! -name "run_rapid" ! -name "*.sh" -delete
...
echo "Cleanup complete. Only 'run_spot', 'run_rapid', and *.sh files remain."
